        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-20">
          <div>
            ...
            <p className="mb-8 text-lg leading-relaxed text-muted-foreground">
              Established in 2012, Balvi Industrial Corporation has grown into a trusted
              name in precision manufacturing. With an annual turnover exceeding 25 Crore,
              we serve clients across India and the Middle East with unmatched quality and
              commitment.
            </p>
